...
export const BRANDING = {
  ...
  agentName: process.env.NEXT_PUBLIC_AGENT_NAME || "Kano",
  ...
  companyName: process.env.NEXT_PUBLIC_COMPANY_NAME || "KANO SYSTEMS, INC.",

  // App title (shown in browser tab)
  appTitle: process.env.NEXT_PUBLIC_APP_TITLE || "Kano",
} as const;
